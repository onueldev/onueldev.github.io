          ...
          {isKo ? (
            <>
              ...
              <section>
                ...
                <ul className={`text-sm space-y-2 list-disc list-inside ${textColor}`}>
                  <li>서비스는 할 일·가계부·일기·메모·식재 관리를 위한 개인 생활 관리 도구입니다.</li>
            ...
            <>
              ...
              <section>
                ...
                <ul className={`text-sm space-y-2 list-disc list-inside ${textColor}`}>
                  <li>The Service is a personal life management tool for tasks, expenses, journal, notes, and pantry management.</li>
